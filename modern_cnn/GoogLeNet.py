...
def train_whole(epochs, net, updater, loss, train_iter, test_iter, device):
    ...
    for i in range(epochs):
        ...
        print(f"train_loss: {train_loss:8.4f}, train_accuracy: {train_accuracy:8.4f}")
        print(f"test_loss : {test_loss :8.4f}, test_accuracy : {test_accuracy :8.4f}")
...
def create_updater(net):
    return torch.optim.SGD(net.parameters(), lr=0.065, momentum=0.9, weight_decay=1e-4)
